...
from password.core.views import core
from password.users.views import users
from password.blog_posts.views import blog_posts
from password.error_pages.handlers import error_pages
